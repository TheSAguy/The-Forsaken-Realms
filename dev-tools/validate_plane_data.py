...
F["TuningData"] = set("""lairReturnRewardFactor lairReturnItemChance enemyTierScaleCommon enemyTierScaleUncommon enemyTierScaleRare enemyTierScaleMythic defeatGoldLossEasy defeatGoldLossNormal defeatGoldLossHard defeatGoldLossInsane coinChallengeFeeEasy coinChallengeFeeNormal coinChallengeFeeHard coinChallengeFeeInsane rewardDuplicateRerolls rewardMaxCopiesPerName deckCardFallbackGold capitolBuiltMageCapBonus capitolBuiltSendsMages legendLifetimeFactor cardBudgetEnabled cardBudgetRepeatCommon cardBudgetRepeatUncommon cardBudgetRepeatRare cardBudgetRepeatMythic cardBudgetFirstCommon cardBudgetFirstUncommon cardBudgetFirstRare cardBudgetFirstMythic cardBudgetFirstWinBonusCards cardBudgetEasyBonus cardBudgetTopUpWeightCommon cardBudgetTopUpWeightUncommon cardBudgetTopUpWeightRare coinChallengeShardFeeEasy coinChallengeShardFeeNormal coinChallengeShardFeeHard coinChallengeShardFeeInsane worldGenNeutralTownCutEasy worldGenNeutralTownCutNormal worldGenNeutralTownCutHard worldGenNeutralTownCutInsane worldGenRuinedTownCutEasy worldGenRuinedTownCutNormal worldGenRuinedTownCutHard worldGenRuinedTownCutInsane resourcePurseEnabled resourcePurseCommon resourcePurseUncommon resourcePurseRare resourcePurseMythic resourcePurseGoldShare resourcePurseUnitValue resourcePurseFavoredWeight resourcePurseOtherWeight resourcePurseColorlessFactor resourcePurseFirstWinFactor resourcePurseLosingRecordFactor mapEnemyDefaultThreatRange mapEnemyDefaultPursueRange dungeonLifespanMinDays dungeonLifespanMaxDays dungeonSpotRestMinDays dungeonSpotRestMaxDays resourcePurseVariance resourcePurseFactorEasy resourcePurseFactorNormal resourcePurseFactorHard resourcePurseFactorInsane townReputationDefensePerPoint townReputationDefenseMaxPoints townMinCaptureChance arenaHigherTierWinPercent aiCapitalTerritoryRadiusFactor playerColorlessMixChance dayLengthSeconds capitolExpansionTilesPerDay townExpansionDaysPerTile aiCastleExpansionTilesPerDay maxTerritoryRadius
...
F["BiomeData"] = set("""startPointX startPointY noiseWeight distWeight name tilesetAtlas tilesetName terrain overlays width height color collision invertHeight
