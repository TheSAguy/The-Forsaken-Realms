...
public class UIScene extends Scene {
    ...
    public void enter() {
        ...
        // Round 165 merge note: upstream's 09.09 daily replaced the body below with a pixelating
        // shader drawable (b09a3d3f009); the null guard is the mod's and stays on top of it.
