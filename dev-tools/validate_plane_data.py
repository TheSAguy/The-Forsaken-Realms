...
F["TuningData"] = set("""enemyTierScaleCommon enemyTierScaleUncommon enemyTierScaleRare enemyTierScaleMythic defeatGoldLossEasy defeatGoldLossNormal defeatGoldLossHard defeatGoldLossInsane coinChallengeFeeEasy coinChallengeFeeNormal coinChallengeFeeHard coinChallengeFeeInsane rewardDuplicateRerolls rewardMaxCopiesPerName deckCardFallbackGold cardBudgetEnabled cardBudgetRepeatCommon cardBudgetRepeatUncommon cardBudgetRepeatRare cardBudgetRepeatMythic cardBudgetFirstCommon cardBudgetFirstUncommon cardBudgetFirstRare cardBudgetFirstMythic cardBudgetFirstWinBonusCards cardBudgetEasyBonus cardBudgetTopUpWeightCommon cardBudgetTopUpWeightUncommon cardBudgetTopUpWeightRare townReputationDefensePerPoint townReputationDefenseMaxPoints townMinCaptureChance arenaHigherTierWinPercent aiCapitalTerritoryRadiusFactor playerColorlessMixChance dayLengthSeconds capitolExpansionTilesPerDay townExpansionDaysPerTile aiCastleExpansionTilesPerDay maxTerritoryRadius
