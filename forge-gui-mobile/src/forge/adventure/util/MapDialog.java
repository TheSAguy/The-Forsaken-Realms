...
public class MapDialog {
    ...
    private boolean loadDialog(DialogData dialog) { //Displays a dialog with dialogue and possible choices.
        ...
        if (dialog.options != null) {
            ...
            // Round 289: upstream's 09.22 shared listener replaces the anonymous one this used to build on
            // every loadDialog(). It reaches the same TypingLabel by walking the dialog's content table
            // instead of closing over the local A, and is created once per MapDialog rather than per load.
