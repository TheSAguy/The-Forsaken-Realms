...
F["TuningData"] = set("""enemyTierScaleCommon enemyTierScaleUncommon enemyTierScaleRare enemyTierScaleMythic defeatGoldLossEasy defeatGoldLossNormal defeatGoldLossHard defeatGoldLossInsane coinChallengeFeeEasy coinChallengeFeeNormal coinChallengeFeeHard coinChallengeFeeInsane rewardDuplicateRerolls rewardMaxCopiesPerName deckCardFallbackGold townReputationDefensePerPoint townReputationDefenseMaxPoints townMinCaptureChance arenaHigherTierWinPercent aiCapitalTerritoryRadiusFactor playerColorlessMixChance dayLengthSeconds capitolExpansionTilesPerDay townExpansionDaysPerTile aiCastleExpansionTilesPerDay maxTerritoryRadius
