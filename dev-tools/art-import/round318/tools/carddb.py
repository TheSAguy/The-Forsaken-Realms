...
# round 316: the cache lives in the enemy_import folder (one level up), never next to the repo copy of this script
CACHE = os.path.join(os.path.dirname(HERE), "carddb.json")
