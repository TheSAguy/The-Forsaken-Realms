...
- Round 322 swapped the angels (angel_1 = male, angel_2 = female) and added `--eyes angel_m=blue,angel_f=blue`
  ...
  `--recolor "A,angel_m=B" --eyes "angel_m=blue,angel_f=blue"`; round 327 made it
  `--eyes "angel_m=blue+gold+green,angel_f=blue+gold+green"` - one selectable portrait per color, blue first.
