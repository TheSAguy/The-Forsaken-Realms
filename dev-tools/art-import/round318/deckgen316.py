r"""deckgen316.py - themed decks for the 43 round-316 enemies: deckgen179.py (the round-179 generator, copied by
...
OUT = sys.argv[1] if len(sys.argv) > 1 and not sys.argv[1].startswith("--") else os.path.join(HERE, "decks")
